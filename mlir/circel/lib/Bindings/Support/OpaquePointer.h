#ifndef MLIR_BINDINGS_SUPPORT_OPAQUE_POINTER_INTERNAL_H_
#define MLIR_BINDINGS_SUPPORT_OPAQUE_POINTER_INTERNAL_H_
...
#endif // MLIR_BINDINGS_SUPPORT_OPAQUE_POINTER_INTERNAL_H_
