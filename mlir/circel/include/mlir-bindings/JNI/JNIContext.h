#ifndef MLIR_BINDINGS_JNI_MLIR_JNI_CONTEXT_H_
#define MLIR_BINDINGS_JNI_MLIR_JNI_CONTEXT_H_
...
public:
  ...
  operator MLIRContext *() const { return context; }
  MLIRContext *operator->() const { return context; }
...
#define MLIR_JNI_DECLARE_CLASS_BINDING(CppType)                                \
  template <> struct ::mlir::bindings::JNIContext::JavaClassBinding<CppType> { \
    static const ::mlir::bindings::JNIContext::JavaClass &getClass();          \
  };
#define MLIR_JNI_DEFINE_CLASS_BINDING(CppType, JavaClassName)                  \
  const ::mlir::bindings::JNIContext::JavaClass                                \
      & ::mlir::bindings::JNIContext::JavaClassBinding<CppType>::getClass() {  \
    static auto &clazz =                                                       \
        mlir::bindings::JNIContext::createJavaClass("" JavaClassName "");      \
    return clazz;                                                              \
  }
...
MLIR_JNI_DECLARE_CLASS_BINDING(Attribute)
MLIR_JNI_DECLARE_CLASS_BINDING(StringAttr)

MLIR_JNI_DECLARE_CLASS_BINDING(Location)
MLIR_JNI_DECLARE_CLASS_BINDING(UnknownLoc)
MLIR_JNI_DECLARE_CLASS_BINDING(FileLineColLoc)
MLIR_JNI_DECLARE_CLASS_BINDING(CallSiteLoc)
MLIR_JNI_DECLARE_CLASS_BINDING(FusedLoc)
MLIR_JNI_DECLARE_CLASS_BINDING(NameLoc)

MLIR_JNI_DECLARE_CLASS_BINDING(Type)
MLIR_JNI_DECLARE_CLASS_BINDING(IntegerType)
MLIR_JNI_DECLARE_CLASS_BINDING(FunctionType)

MLIR_JNI_DECLARE_CLASS_BINDING(Block *)
MLIR_JNI_DECLARE_CLASS_BINDING(Region *)

MLIR_JNI_DECLARE_CLASS_BINDING(Value)
MLIR_JNI_DECLARE_CLASS_BINDING(OpResult)

MLIR_JNI_DECLARE_CLASS_BINDING(OpState)
MLIR_JNI_DECLARE_CLASS_BINDING(ModuleOp)
...
#endif // MLIR_BINDINGS_JNI_MLIR_JNI_CONTEXT_H_
